        ...
        <div class="px-4 sm:px-6 lg:px-8 bg-transparent py-10 h-screen max-w-7xl mx-auto">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <Breadcrumbs class="mb-4" :pages="[{name:'Carburant',href:route('fuels.index'),current:true}]"></Breadcrumbs>
                </div>
...
const createOrEditItem = () => {
    ...
    if (!item_id.value) {
        ...
        axios.put(route('fuels.update', {fuel: item_id.value}), {
            label: form.label,
        }).then((response) => {
            form.processing = false;
