            ...
            <div class="sm:flex sm:items-center  max-w-7xl mx-auto mb-10">
                <div class="sm:flex-auto">
                    <Breadcrumbs class="mb-4"
                                 :pages="[{name:'Pointages',href:route('pointages.index'),current:true}]"></Breadcrumbs>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <Link :href="route('pointages.create')"
            ...
            <div class=" bg-transparent pb-10 h-screen  mx-auto">
                ...
                <div class="maintenanced">
                    <Paginator :rows="items.per_page" v-model:first="page" :totalRecords="items.total"
                               @page="event=>router.get(route('pointages.index'),{page:1+event.page})">
...
const loadPage = (v) => {
    router.get(route('pointages.index'), {field: field._value, order: v})
}
